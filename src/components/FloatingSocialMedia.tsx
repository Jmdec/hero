...
const FloatingSocialMedia = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      name: "TikTok",
      icon: TikTokIcon,
      href: "https://www.tiktok.com/@heroservicedoffice?brid=YWdncwE0mJXxBJyZ5NOG6DnvTX4Y",
    ...
    },
    {
      name: "Instagram",
      icon: InstagramIcon,
      href: "https://www.instagram.com/heroso.ph?brid=YWdncwFxH46XEfmIdj75Ic2AkD1v",
    ...
    },
    {
      name: "Facebook",
      icon: FacebookIcon,
      href: "https://www.facebook.com/heroservicedoffice",
