                ...
                {contacts.map((c) => (
                  <article key={c.id} className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
                    ...
                    <div className="mt-3 grid grid-cols-1 gap-1.5 text-xs text-slate-600">
                      <p>
                        <span className="font-semibold text-slate-800">Inquiry:</span> {INQUIRY_LABELS[c.inquiry_type] ?? c.inquiry_type}
                      </p>
                      <p>
                        <span className="font-semibold text-slate-800">Date:</span> {formatDate(c.created_at)}
                      </p>
                    </div>
